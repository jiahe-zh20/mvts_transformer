...
class Options(object):
    ...
    def __init__(self):
        ...
        # I/O
        self.parser.add_argument('--output_dir', default='./ex_log/epoch20',
        ...
        self.parser.add_argument('--data_class', type=str, default='vol',
        ...
        self.parser.add_argument('--model', choices={"transformer", "LINEAR"}, default="transformer",
                                 help="Model class")
        self.parser.add_argument('--max_seq_len', choices={150, 250}, default=250, type=int,
